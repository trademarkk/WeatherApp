...
export const SearchBar = ({ search, setSearch }) => {
  return (
    <div className="relative flex justify-center w-[711px] h-[66px] self-center justify-self-center mb-14">
      <input
        value={search}
        onChange={(e) => {
        ...
        type="text"
        className="w-full bg-neutral-400 pl-20 pr-4 py-2 border border-gray-300 rounded-3xl focus:outline-none focus:ring-2 focus:ring-blue-500 font-light text-3xl text-[#524e4e]"
